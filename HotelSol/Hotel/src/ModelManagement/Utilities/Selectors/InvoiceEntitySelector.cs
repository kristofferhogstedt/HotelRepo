...
{
    public class InvoiceEntitySelector
    {
        public static IInvoice Select(List<IInvoice> entityList, int startIndex, IMenu previousMenu)
        {
            ...
            {
                Console.Clear();
                InvoiceDisplayer.RenderTable(entityList, _selectedIndex);
