    ...
    public class RoomSeeder : ISeedable
    {
        ...
        public static List<IRoom> CreateSeed()
        {
            ...
            var _rooms = new List<IRoom>()
            {
                ...
                new Room{Name="103",Description="Room 103",Details = new RoomDetails{RoomType = (RoomType)RoomTypeService.GetOneByRoomType("Single", _getRelatedObjects), NumberOfBeds=1, Size=15, Price=800},Floor=1},
                new Room{Name="104",Description="Room 104",Details = new RoomDetails{RoomType = (RoomType)RoomTypeService.GetOneByRoomType("Single", _getRelatedObjects), NumberOfBeds=1, Size=15, Price=800},Floor=1},
                ...
                new Room{Name="203",Description="Room 203",Details = new RoomDetails{RoomType = (RoomType)RoomTypeService.GetOneByRoomType("Single", _getRelatedObjects), NumberOfBeds=1, Size=15, Price=800},Floor=2},
